...
config["image_shape"] = (128,128,24)#(144, 144, 144)#(128, 128, 24)  # This determines what shape the images will be cropped/resampled to.
config["patch_shape"] = None #(72, 72, 72) #None #(128, 128, 24)#None#(16, 16, 62)  # switch to None to train on the whole image
...
config["flip"] = None  # augments the data by randomly flipping an axis during
config["permute"] = False #True  # data shape must be a cube. Augments the data by permuting in various directions
